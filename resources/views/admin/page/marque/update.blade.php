            ...
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.marque.edit',$marque->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class=" form-control" id="raison_sociale" name="raison_sociale" value="{{$marque->raison_sociale}}" minlength="2" type="text"  />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="cname" class="control-label col-lg-2">Site internet </label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="site" name="site" value="{{$marque->site}}" minlength="2" type="text"  />
                  </div>
                </div>
                <div class="form-group ">
                  ...
                  <div class="col-lg-10 col-sm-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                        ...
                        <img src="{{asset('/storage/avatars/'.$marque->logo)}}" alt="" />
                      </div>
