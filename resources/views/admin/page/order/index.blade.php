    ...
    <div class="row mt">
      <div class="col-lg-12">
        <div class="content-panel">
          <h4><i class="fa fa-angle-right"></i> Commandes Reglées</h4>
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-3 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande_reglee.search_date')}}">
                @csrf
            ...
            <div class="col-md-6 col-sm-6 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande_reglee.search_entre')}}">
                @csrf
                <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 mb">
              <form class="form-inline" role="form" action="{{route('administration.commande_reglee.search_nom')}}">
                @csrf
                <div class="form-group">
            ...
            <table class="table table-bordered table-striped table-condensed cf" style="font-size: 18px">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="numeric" data-title="Price"><a href="/administration/commande_reglee/send/{{$type->id}}"> Envoyer</i></a></td>
