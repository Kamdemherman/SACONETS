    ...
    <div class="row mt">
      <div class="col-lg-12">
        <div class="content-panel">
          <h4><i class="fa fa-angle-right"></i> Candidature</h4>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-3 mb">
              <form class="form-inline" role="form" action="{{route('administration.candidature.search')}}">
                @csrf
          ...
          <section id="no-more-tables">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="numeric" data-title="Change">
                    <form action="/administration/candidature/destroy/{{$type->id}}" method="DELETE">
                      @csrf
                      @method('DELETE')
                      <a href="/administration/candidature/destroy/{{$type->id}}" type="button" onclick="return confirm('Are you sure?')" title="Supprimer"><i class="fa fa-trash-o" style="color: red" aria-hidden="true" ></i></a></td>
            ...
            <div style="text-align: right; margin: 15px">{{$candidatures->links()}}</div>
          </section>
        </div>
        <!-- /content-panel -->
      </div>
