            ...
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.produit')}}" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <textarea class="form-control" name="caracteristique" id="caracteristique" placeholder="Your caracteristique" rows="5" data-rule="required" data-msg="Your caracteristique"></textarea>
                  </div>
                </div>
                <div class="form-group ">
