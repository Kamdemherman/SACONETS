            ...
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.about.edit',$about->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class=" form-control" id="short" name="short" value="{{$about->short}}" minlength="2" type="text" required />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="cname" class="control-label col-lg-2">Petite description_en </label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="short_en" name="short_en" value="{{$about->short_en}}" minlength="2" type="text" required />
                  </div>
                </div>
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <textarea class="form-control" name="libelle" id="libelle" placeholder="Your description" rows="5" data-rule="required" data-msg="Your description">{{$about->libelle}}</textarea>
                  </div>
                </div>
                ...
                <div class="form-group ">
                  <label for="cname" class="control-label col-lg-2">Libellé </label>
                  <div class="col-lg-10">
                    <textarea class="form-control" name="libelle_en" id="libelle_en" placeholder="Your description" rows="5" data-rule="required" data-msg="Your description">{{$about->libelle_en}}</textarea>
                  </div>
                </div>
                <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-4 mb">
                      <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                          ...
                          <img src="{{asset('/storage/imgs/'.$about->image)}}" alt="" />
                        </div>
                    ...
                    <div class="col-md-3 col-sm-4 mb">
                      <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                          <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=no+image" alt="" />
                          <img src="{{asset('/storage/imgs/'.$about->image2)}}" alt="" />
                        </div>
                        <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                        <div>
                          <span class="btn btn-theme02 btn-file">
