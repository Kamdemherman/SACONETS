            ...
            <div class=" form">
              <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="{{route('administration.slider.edit',$slider->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class=" form-control" id="titre" name="titre" minlength="2" type="text" value="{{$slider->titre}}"  />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="titre_en" class="control-label col-lg-2">Titre_en </label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="titre_en" name="titre_en" minlength="2" type="text" value="{{$slider->titre_en}}"  />
                  </div>
                </div>
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <textarea class="form-control" name="paragraphe" id="paragraphe" placeholder="Votre paragraphe" rows="5" >{{$slider->paragraphe}}</textarea>
                  </div>
                </div>
                <div class="form-group ">
                  <label for="paragraphe_en" class="control-label col-lg-2">Paragraphe_en </label>
                  <div class="col-lg-10">
                    <textarea class="form-control" name="paragraphe_en" id="paragraphe_en" placeholder="Votre paragraphe en anglais" rows="5" >{{$slider->paragraphe_en}}</textarea>
                  </div>
                </div>
                <div class="form-group ">
                  <label for="lien" class="control-label col-lg-2">Bouton </label>
                  <div class="col-lg-10">
                    <input class=" form-control" id="lien" name="lien" minlength="2" type="text" value="{{$slider->lien}}" />
                  </div>
                </div>
                <div class="form-group ">
