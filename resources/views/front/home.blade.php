    ...
    <div class="container pb-23 pb-md-25">
      <div class="row mb-14">
        <div class="col-12 mt-n18 mt-md-n20 mt-lg-n21 position-relative">
          ...
          <figure class="rounded"><img src="dist/assets/img/photos/about18.jpg" srcset="dist/assets/img/photos/about18@2x.jpg 2x" alt="" /></figure>
        </div>
        <!-- /column -->
      </div>
      <!-- /.row -->
      <div class="row gx-lg-8 gx-xl-12 gy-8">
        <div class="col-md-6 col-lg-4">
          <div class="d-flex flex-row">
            <div>
              <img src="dist/assets/img/icons/solid/target.svg" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary me-4" alt="" />
            </div>
            <div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="d-flex flex-row">
            <div>
              <img src="dist/assets/img/icons/solid/video-chat.svg" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary me-4" alt="" />
            </div>
            <div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="d-flex flex-row">
            <div>
              <img src="dist/assets/img/icons/solid/wallet.svg" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary me-4" alt="" />
            </div>
            <div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="d-flex flex-row">
            <div>
              <img src="dist/assets/img/icons/solid/building.svg" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary me-4" alt="" />
            </div>
            <div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="d-flex flex-row">
            <div>
              <img src="dist/assets/img/icons/solid/alarm.svg" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary me-4" alt="" />
            </div>
            <div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="d-flex flex-row">
            <div>
              <img src="dist/assets/img/icons/solid/employees.svg" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary me-4" alt="" />
            </div>
            <div>
              ...
              <div class="card-body">
                ...
                <blockquote class="icon mb-0">
                  ...
                  <div class="blockquote-details">
                    <img class="rounded-circle w-12" src="dist/assets/img/avatars/te1.jpg" srcset="dist/assets/img/avatars/te1@2x.jpg 2x" alt="" />
                    <div class="info">
            ...
            <div class="card shadow-lg">
              <div class="card-body">
                ...
                <blockquote class="icon mb-0">
                  ...
                  <div class="blockquote-details">
                    <img class="rounded-circle w-12" src="dist/assets/img/avatars/te2.jpg" srcset="dist/assets/img/avatars/te2@2x.jpg 2x" alt="" />
                    <div class="info">
            ...
            <div class="card shadow-lg">
              <div class="card-body">
                ...
                <blockquote class="icon mb-0">
                  ...
                  <div class="blockquote-details">
                    <img class="rounded-circle w-12" src="dist/assets/img/avatars/te3.jpg" srcset="dist/assets/img/avatars/te3@2x.jpg 2x" alt="" />
                    <div class="info">
            ...
            <div class="card shadow-lg">
              <div class="card-body">
                ...
                <blockquote class="icon mb-0">
                  ...
                  <div class="blockquote-details">
                    <img class="rounded-circle w-12" src="dist/assets/img/avatars/te4.jpg" srcset="dist/assets/img/avatars/te4@2x.jpg 2x" alt="" />
                    <div class="info">
                      <h5 class="mb-1">Coriss Ambady</h5>
                      <p class="mb-0">Financial Analyst</p>
                    </div>
            ...
            <div class="card shadow-lg">
              <div class="card-body">
                ...
                <blockquote class="icon mb-0">
                  ...
                  <div class="blockquote-details">
                    <img class="rounded-circle w-12" src="dist/assets/img/avatars/te5.jpg" srcset="dist/assets/img/avatars/te5@2x.jpg 2x" alt="" />
                    <div class="info">
            ...
            <div class="card shadow-lg">
              <div class="card-body">
                ...
                <blockquote class="icon mb-0">
                  ...
                  <div class="blockquote-details">
                    <img class="rounded-circle w-12" src="dist/assets/img/avatars/te6.jpg" srcset="dist/assets/img/avatars/te6@2x.jpg 2x" alt="" />
                    <div class="info">
