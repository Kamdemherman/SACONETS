  ...
  <div class="container py-12 py-md-16 text-center">
    <div class="row">
      <div class="col-md-12 col-lg-6 col-xl-5 mx-auto mb-10">
        <h1 class="display-1 mb-3" style="color: #fff">{{ __('Services')}}: {{ __('Tracking') }}</h1>
...
{{-- <section class="wrapper bg-light wrapper-border">
  <div class="container py-11">
    <ul class="list-inline mb-0">
      ...
      <li class="list-inline-item me-1 mb-2"><a href="{{route('tracking')}}" class="btn btn-primary rounded-0" >{{ __('Tracking') }}</a></li>
          ...
          <div class="col-xxl-8 mx-auto">
            <div class="form-floating mb-4">
                <textarea id="object" class="form-control"  style="height: 150px" name="object" id="object" required></textarea>
                  ...
                  <label for="object">{{ __('Requesting information for:')}} {{$tracke->libelle}}*</label>
