  ...
  <div class="container py-12 py-md-16 text-center">
    <div class="row">
      <div class="col-md-12 col-lg-8 col-xl-9 mx-auto mb-10">
        <h1 class="display-1 mb-3" style="color: #fff">{{ __('Services')}}: {{ __('Mobile satellite telephony') }}</h1>
...
<section class="wrapper bg-light wrapper-border">
  <div class="container py-11">
    <ul class="list-inline mb-0">
      ...
      <li class="list-inline-item me-1 mb-2"><a href="{{route('telephonie-mobile-par-satellite')}}" class="btn btn-primary rounded-0" >{{ __('Mobile satellite telephony') }}</a></li>
      ...
      <div class="row" style="padding-bottom: 0px">
        <div class="col-xxl-6 mx-auto mb-5">
          @if (app()->getLocale() == 'en')
            ...
            <h2 class="post-title display-5" style="margin-top: 0px"><a href="" class="link-dark">{{$telephone->libelle_en}}</a></h2>
          @else

            <h2 class="post-title display-5 " style="margin-top: 0px"><a href="" class="link-dark">{{$telephone->libelle}}</a></h2>
          @endif
            @if (app()->getLocale() == 'en')
            <p style="margin-top: 0px">{!! $telephone->description_en !!}</p>
            @else
            <p style="margin-top: 0px">{!! $telephone->description !!}</p>
            @endif
        ...
        <div class="col-xxl-6 mx-auto">
          <figure style="margin-top: 0px"><a href="" target="_blank"><img class="img-fluid" src="{{asset('/storage/imgs/'.$telephone->image)}}" alt=""></a></figure>
        </div>
        <!-- /column -->
      </div>
      <!-- /.row -->
          ...
          <div class="col-xxl-8 mx-auto">
            <div class="form-floating mb-4">
                <textarea id="object" class="form-control"  style="height: 150px" name="object" id="object" required></textarea>
                  ...
                  <label for="object">{{ __('Requesting information for:')}} {{$telephone->libelle}}*</label>
