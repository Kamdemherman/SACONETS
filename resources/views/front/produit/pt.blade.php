          ...
          <div>
              <nav class="d-inline-block" aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 mt-10" style="padding-top: 40px">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Thuraya') }}</li>
            ...
            <div class="row gx-md-5 gy-5 text-center">
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card shadow-lg">
                  <div class="card-body">
                    <a href="/produit-telephone-thuraya/edit/{{$service->id}}">
                    <img src="{{asset('/storage/imgs/'.$service->image)}}" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" style="height: 250px;" alt="" />
                  </a>
                    @if (app()->getLocale() == 'en')
                    ...
                    <a href="/produit-telephone-thuraya/edit/{{$service->id}}" class="more hover link-yellow">{{ __('Read More') }}</a>
